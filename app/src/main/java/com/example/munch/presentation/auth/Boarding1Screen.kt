...
import com.example.munch.Munch
...
fun Boarding1Screen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Image(
                painterResource(id = R.drawable.boarding1),
            ...
            Column(
                ...
                Text(
                    "Mulai pengalaman tanpa batas memesan makananmu disini!",
                    fontSize = 16.sp,
            ...
            CustomButton(
                ...
                text = "Lanjutkan",
                onClick = {
                    authNavController.navigate(AuthNavObj.Boarding2Screen.route)
                },
